import SwiftUI
@available(iOS 13.0, *)
public struct LighterTextField: View {
...
public class EGTextFieldConfig{
    ...
    public var defaultFocusedBorderColor : Color = Color.lighterPrimary
    ...
    public var textFieldHeight : CGFloat = 56
}
